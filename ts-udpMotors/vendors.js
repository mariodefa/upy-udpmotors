...
module.exports = {
  "thrustmaster": {
    ...
    "update": function(data) {
      ...
      state['button:T'] = data[11] >> 4 & 1;
      state['button:O'] = data[12] >> 5 & 1;
      state['button:X'] = data[13] >> 6 & 1;
      state['button:S'] = data[14] >> 7 & 1;

      state['button:L1'] = data[15] >> 0 & 1;
      state['button:R1'] = data[16] >> 1 & 1;
      state['button:L2'] = data[17] >> 2 & 1;
      state['button:R2'] = data[18] >> 3 & 1;

      state['axis:JOYL:Y'] = data[4];
      state['axis:JOYL:X'] = data[3];
      state['axis:JOYR:Y'] = data[6];
      state['axis:JOYR:X'] = data[5];

      state['button:Up'] = data[2] >> 0 & 1;
      state['button:Right'] = data[2] >> 1 & 1;
      state['button:Down'] = data[2] >> 2 & 1;
      state['button:Left'] = data[2] >> 3 & 1;

      state['button:Start'] = data[7] >> 5 & 1;
      state['button:Select'] = data[7] >> 4 & 1;
